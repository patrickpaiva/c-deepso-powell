...
fun_fitness = bench.get_function(14)
def schwefel_overlapping(sol):
    return fun_fitness(sol)

def function_ambigua(sol):
    fun_fitness = schwefel_overlapping
    if sol.ndim == 2:
...
func_name = 'f14_schwefel_overlapping'
